...
class JSONSchemaPlugin(plugin.PyangPlugin):
    ...
    def add_opts(self, optparser):
        optlist = [
            ...
            optparse.make_option(
                "--jsonschema-path", dest="schema_path", help="JSON Schema path"
            ),
            optparse.make_option(
                "--jsonschema-title", dest="schema_title", help="JSON Schema title"
            ),
        ]
        ...
        for child in stmt.i_children:
            if child.keyword in producers:
                ...
                if stmt.parent.keyword != "list":
                    ...
                    result["properties"][arg]["items"].append(
...
def produce_container(stmt):
    ...
    if stmt.parent.keyword != "list":
        ...
        result = {
            "type": "object",
            "properties": {arg: {"type": "object", "properties": {}}},
        }
        ...
        for child in stmt.i_children:
            if child.keyword in producers:
                ...
                if stmt.parent.keyword != "list":
                    ...
                    result["properties"][arg]["properties"].update(
                        producers[child.keyword](child)
                    )
            else:
                logging.debug("keyword miss on: %s %s", child.keyword, child.arg)
